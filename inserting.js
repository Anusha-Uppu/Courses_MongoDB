...
function run() {
    ...
    try {
        ...
        fs.createReadStream("./Coursesdata - Sheet1.csv", { encoding: 'utf-8' })
            //.pipe(csvParser())
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, Course_1.Courses.insertMany(result_array)];
                    case 2:
                        _a.sent();
                        result_array.forEach(function (element) {
                            if (element.prerequisite == null) {
                                ...
                                element.prerequisite.forEach(function (ele) {
                                    var id = Course_1.Courses.findOne({ name: ele });
                                    console.log(id);
                                });
                            }
                        });
